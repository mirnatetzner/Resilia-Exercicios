...
codifica.addEventListener("click", function (){
    ...
    agir.addEventListener("click", function (){
        ...
        //Essa parte do código é para codificar base64
            res.innerHTML = `<span>Codificado:</span><textarea id="caixa-resposta" cols="35" rows="3">${btoa(document.querySelector('#msg').value)}</textarea>`;
        } else {
        //Essa parte do código é para codificar em Cifra de César
            ...
            res.innerHTML = `<span>Codificado:</span> <textarea id="caixa-resposta" cols="35" rows="3">${stringf}</textarea>`;
        }
    })
})
